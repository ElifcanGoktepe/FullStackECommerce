...
import FeatureListComponent from '../../components/ormasims/FeatureListComponent'
import OfferListComponent from '../../components/ormasims/OfferListComponent'
import TrendProductComponent from '../../components/ormasims/TrendProductComponent'
import JustArrivedComponen from '../../components/ormasims/JustArrivedComponen'
function HomePage() {
  return (
   <>
