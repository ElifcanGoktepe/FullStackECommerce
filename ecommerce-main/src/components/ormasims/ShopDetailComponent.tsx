...
import formatCurrency from '../../tools/currencyFormatter';
interface IShopeDetailComponentProps {
    id: string | undefined;
}

function ShopDetailComponent( props: IShopeDetailComponentProps) {
    const [product, setProduct] = useState<IProductModel | undefined>();
    useEffect(() => {
        fetch('http://34.10.50.108:9090/dev/v1/product/find-by-product-id/' + props.id)
        .then(res=> res.json())
        ...
        <div className="row px-xl-5">
            ...
            <div className="col-lg-7 pb-5">
                ...
                <div className="d-flex mb-3">
                    ...
                    <small className="pt-1">(Stock: {product?.stock})</small>
                </div>
                <h3 className="font-weight-semi-bold mb-4">{product?.price && formatCurrency(product?.price)}</h3>
